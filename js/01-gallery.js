...
function onKeyPressArrowLeft(e) {
  ...
  if (e.key === "ArrowLeft") {
    ...
    let indexCurrentImg = originalImgArray.findIndex(
      (img) => img === lightBoxRef.src
    );

    lightBoxRef.src =
      originalImgArray[
        indexCurrentImg === 0
          ? originalImgArray.length - 1
          : indexCurrentImg - 1
      ];
  }
}
...
function onKeyPressArrowRight(e) {
  ...
  if (e.key === "ArrowRight") {
    ...
    lightBoxRef.src =
      originalImgArray[
        indexCurrentImg === originalImgArray.length - 1
          ? 0
          : indexCurrentImg + 1
      ];
  }
